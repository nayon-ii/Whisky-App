  ...
  return (
    <SafeAreaView className="flex-1 bg-surface">
      <View className="flex-1 px-5 py-4">
        ...
        >
          <View className="bg-white rounded-xl p-6 flex-row items-center">
            <View className="relative">
              <Image
                source={{
                  uri: user?.avatar || "https://images.pexels.com/photos/1040880/pexels-photo-1040880.jpeg",
                }}
        ...
        <View className="bg-white rounded-xl p-4">
          ...
          <ProfileMenuItem
            icon={CreditCard}
            title="Payment"
            onPress={() => router.push("/(screen)/payment" as any)}
          />
          <ProfileMenuItem
            icon={FileText}
